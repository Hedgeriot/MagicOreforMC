...
public abstract class MagicMove extends Entity implements IProjectile
{
    ...
    public MagicMove(World p_i1776_1_)
    {
        super(p_i1776_1_);
    ...
    public MagicMove(World p_i1777_1_, EntityLivingBase p_i1777_2_)
    {
        super(p_i1777_1_);
    ...
    public MagicMove(World p_i1778_1_, double p_i1778_2_, double p_i1778_4_, double p_i1778_6_)
    {
        super(p_i1778_1_);
    ...
    /**
     * Called when this MagicMove hits a block or entity.
     */
